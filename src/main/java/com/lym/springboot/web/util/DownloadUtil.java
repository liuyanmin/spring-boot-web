...
public final class DownloadUtil {
     ...
     * @throws Exception
     */
    public static void download( String downloadDir, String downloadFileName, List<String> allowFileExtensions,
     ...
     */
    public static void download(String downloadDir, String downloadFileName, List<String> allowFileExtensions,
                                HttpServletResponse response, DownloadHandler downloadHandler) throws Exception {
